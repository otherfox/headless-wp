...
This is a forum where we can share ideas about dev projects built with React and Wordpress.

Installation Instructions:

1. Set your baseurl for you local environment in services/api/setting.js.
